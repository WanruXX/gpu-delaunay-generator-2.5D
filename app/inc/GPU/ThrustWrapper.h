#ifndef GDEL2D_THRUSTWRAPPER_H
#define GDEL2D_THRUSTWRAPPER_H
...
int compactIfNegative(DevVector<int> &inVec, DevVector<int> &temp);
...
{
    double _minVal, _range;

    GetMortonNumber(double minVal, double maxVal) : _minVal(minVal), _range(maxVal - minVal)
    {
    }

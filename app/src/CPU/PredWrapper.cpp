...
PredWrapper2D::PredWrapper2D(const Point2HVec &pointVec, Point2 ptInfty)
{
...
Side PredWrapper2D::doIncircle(Tri tri, int vert) const
{
    ...
    const Point2 pt[] = {getPoint(tri._v[0]), getPoint(tri._v[1]), getPoint(tri._v[2]), getPoint(vert)};

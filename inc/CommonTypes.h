...
struct Point2
{
    ...
    Point2(double x, double y) : _p{x, y} {};

    INLINE_H_D

    bool lessThan(const Point2 &pt) const
    {
        if (_p[0] < pt._p[0])
            return true;
        if (_p[0] > pt._p[0])
    ...
    bool equals(const Point2 &pt) const
    {
...
struct Tri
{
    ...
    bool equals(const Tri &tri) const
    {
    ...
    bool operator==(const Tri &pt) const
    {
        return equals(pt);
    }
...
Tri makeTri(int v0, int v1, int v2)
{
...
INLINE_H_D
    ...
    void
    setBitState(T &c, int bit, bool state)
{
    const T val = (1 << bit);
    c           = state ? (c | val) : (c & ~val);
}
...
bool isOppValConstraint(int val)
{
...
void setOppValTri(int &val, int idx)
{
    val = (val & 0x0F) | (idx << 4);
}
...
void setOppValTriVi(int &val, int idx, int vi)
{
...
int getTriIdx(int input, int oldVi)
{
...
int getTriVi(int input, int oldVi)
{
    int idxVi = (input >> (oldVi * 4)) & 0xf;
...
struct TriOpp
{
    ...
    void setOpp(int vi, int triIdx, int oppTriVi)
    {
    ...
    void setOpp(int vi, int triIdx, int oppTriVi, bool isConstraint)
    {
    ...
    void setOppTriVi(int vi, int triIdx, int oppTriVi)
    {
    ...
    void setOppConstraint(int vi, bool val)
    {
    ...
    void setOppSpecial(int vi, bool state)
    {
    ...
    bool isNeighbor(int triIdx) const
    {
    ...
    bool isOppSpecial(int vi) const
    {
    ...
    bool isOppConstraint(int vi) const
    {
...
void setTriAliveState(char &c, bool b)
{
    setBitState(c, 0, b);
}
...
TriCheckState getTriCheckState(char c)
{
...
void setTriCheckState(char &c, TriCheckState s)
{
    if (Checked == s)
...
void setTriPairType(char &c, PairType p)
{
    c = (c & 0xF3) | (p << 2);
}
...
PairType getTriPairType(char c)
{
...
struct Segment
{
    ...
    bool operator!=(const Segment &pt) const
    {
        return !equals(pt);
    }
    ...
    bool lessThan(const Segment &seg) const
    {
        if (_v[0] < seg._v[0])
            return true;
        if (_v[0] > seg._v[0])
...
int makeConsFlipVote(int triIdx, ConsFlipPriority priority)
{
...
int getConsFlipVoteIdx(int vote)
{
...
ConsFlipPriority getConsFlipVotePriority(int vote)
{

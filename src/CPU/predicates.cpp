...
/*   `d_i', `d_j', `_k', `_l', `_m', and `_n' are declared `INEXACT' because   */
...
void exactinit()
{
    ...
    int cword = 4722; /* Set FPU control word for double precision */
    _FPU_SETCW(cword);
...
double orient2dadapt(const double *pa, const double *pb, const double *pc, const double detsum)
{
